                                ...
                                <div class="stat-card mb-3"> 
                                    ...
                                    <div class="px-2 py-2 mt-0">
                                        ...
                                        @if($u->id == request()->user()->id && $session)
                                            ...
                                            <ul class="nav flex-column">
                                                <li>Ouverture : {{$session->opened_at}}</li>
                                                <li>Fermeture : {{$session->closed_at}}</li>
                                                <li></li>
                                                <li>Nombre de vente  : {{$session->nombre_ventes}}</li>
                                                <li>Total ventes  : {{$session->total_ventes}}</li>
                                                <li>Total encaisse  : {{$session->total_encaisse}}</li>
                                            </ul>
                                        @endif
                                    </div>
                                </div>
