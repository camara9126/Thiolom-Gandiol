            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <span><i class="fas fa-box" style="color: var(--primary); margin-right: 0.5rem;"></i>Liste des Depenses</span>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"  data-bs-target="#depenseModal">
                            Nouveau depense →
                        </button>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="">
                                <thead>
                                    <tr>
                                        <th style="background-color: #FF998F;" class="text-white">Reference</th>
                                        <th style="background-color: #FF998F;" class="text-white">Date</th>
                                        <th style="background-color: #FF998F;" class="text-white">Libelle</th>
                                        <th style="background-color: #FF998F;" class="text-white">Montant</th>
                                        <th style="background-color: #FF998F;" class="text-white">Statut</th>
                                    </tr>
                                </thead>
                                <tbody>
